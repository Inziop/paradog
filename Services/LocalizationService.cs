...
public class LocalizationService : INotifyPropertyChanged
{
    ...
    private readonly Dictionary<string, Dictionary<string, string>> _translations = new()
    {
        ["en"] = new Dictionary<string, string>
        {
            ...
            ["MemoryLimitLabel"] = "Translation Memory Limit (entries):",
            ["MemoryLimitDescription"] = "Maximum number of translations to remember (20K - 1.5M)",
        ...
        ["vi"] = new Dictionary<string, string>
        {
            ...
            ["MemoryLimitLabel"] = "Giới hạn bộ nhớ dịch (số entries):",
            ["MemoryLimitDescription"] = "Số lượng bản dịch tối đa được lưu (20K - 1.5M)",
